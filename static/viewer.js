...
var DEFAULT_URL = STATIC_URL+"test.pdf";
...
/*
 * This view will contain the thumbnails.
 */
...
window.addEventListener('keydown', function keydown(evt) {
  ...
  if (cmd === 0) { // no control key pressed at all.
    switch (evt.keyCode) {
      ...
      case 75: // 'k'
      case 80: // 'p'
        socket.emit('my event', {data: "previous", value:"0"});
        handled = true;
        break;
      case 27: // esc key
      ...
      case 74: // 'j'
      case 78: // 'n'
        socket.emit('my event', {data: "next", value:"0"});
        handled = true;
        break;
